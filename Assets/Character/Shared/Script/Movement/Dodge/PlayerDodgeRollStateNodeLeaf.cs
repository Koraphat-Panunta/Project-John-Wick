...
public class PlayerDodgeRollStateNodeLeaf : PlayerStateNodeLeaf,INodeLeafTransitionAble
{
    ...
    public override void Enter()
    {
        ...
        playerMovement.AddForcePushInstantly(player._dodgeImpluseForce * (player.inputMoveDir_World + player._movementCompoent.curMoveVelocity_World.normalized).normalized, IMotionImplusePushAble.PushMode.IgnoreMomentum);
    ...
    public override void UpdateNode()
    {
        ...
        {
            playerMovement.UpdateMoveToDirWorld(Vector3.zero, player._dodgeInAirStopForce, MoveMode.MaintainMomentumDirection);
        ...
        {
            playerMovement.UpdateMoveToDirWorld(Vector3.zero, player._dodgeOnGroundStopForce, MoveMode.MaintainMomentumDirection);
