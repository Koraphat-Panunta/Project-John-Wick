...
public class WeaponHandIK_ConstraintSCRP : HandIK_ConstraintSCRP
{
    ...
    public Vector3 lean_Left_Additional_Position_Offset;
    public Vector3 lean_Left_Additional_Rotation_Offset;

    public Vector3 lean_Right_Additional_Position_Offset;
    public Vector3 lean_Right_Additional_Rotation_Offset;
