...
public class WeaponGotDisarmedGunFuGotInteractNodeLeaf : GunFu_GotInteract_NodeLeaf
{
    ...
    public override void Enter()
    {
        ...
        enemy.animator.CrossFade(stateName, 0, 0,weaponGotDisarmedScriptableObject.enterNormalizedTime);
    ...
    public override void UpdateNode()
    {
        ...
        enemy._movementCompoent.UpdateMoveToDirWorld(Vector3.zero, enemy.breakMaxSpeed, enemy.breakMaxSpeed, MoveMode.MaintainMomentum);
        base.UpdateNode();
    }
}
