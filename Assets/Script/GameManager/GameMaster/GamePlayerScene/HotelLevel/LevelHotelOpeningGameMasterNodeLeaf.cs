...
public class LevelHotelOpeningGameMasterNodeLeaf : GameMasterNodeLeaf<LevelHotelGameMaster>
{
    ...
    public LevelHotelOpeningGameMasterNodeLeaf(LevelHotelGameMaster gameMaster, Func<bool> preCondition) : base(gameMaster, preCondition)
    {
    ...
    public override void UpdateNode()
    {
        ...
        else if(curPhase == LevelHotelOpeningPhase.FadeOut)
        {
            ...
            if (eplapesTime >= 2)
            {
                ...
                gameMaster.curLevelHotelPhase = LevelHotelGameMaster.LevelHotelPhase.Gameplay;
            }
        }
    }
