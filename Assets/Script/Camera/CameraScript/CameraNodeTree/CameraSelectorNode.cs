...
public class CameraSelectorNode :CameraNode, INodeSelector
{
    ...
    public CameraSelectorNode(CameraController cameraController, Func<bool> preCondition) : base(cameraController, preCondition)
    {
