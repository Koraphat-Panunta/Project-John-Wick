...
public class QuickSwitch_AimDownSight_NodeLeaf : AimDownSightWeaponManuverNodeLeaf, IQuickSwitchNode
{
    ...
    public QuickSwitch_AimDownSight_NodeLeaf(IRangeWeaponAdvanceUser weaponAdvanceUser,IQuickSwitchWeaponManuverAble quickSwitchWeaponManuverAble, Func<bool> preCondition) : base(weaponAdvanceUser, preCondition)
    {
